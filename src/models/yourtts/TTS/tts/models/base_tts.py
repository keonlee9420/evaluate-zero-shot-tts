...
from yourtts.TTS.model import BaseModel
from yourtts.TTS.tts.datasets import TTSDataset
from yourtts.TTS.tts.utils.speakers import SpeakerManager, get_speaker_manager, get_speaker_weighted_sampler
from yourtts.TTS.tts.utils.languages import LanguageManager, get_language_weighted_sampler
...
class BaseTTS(BaseModel):
    ...
    def get_characters(config: Coqpit) -> str:
        ...
        if config.characters is not None:
            ...
            from yourtts.TTS.tts.utils.text.symbols import parse_symbols, phonemes, symbols
