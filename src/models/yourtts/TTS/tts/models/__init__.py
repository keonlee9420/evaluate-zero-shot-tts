from yourtts.TTS.tts.utils.text.symbols import make_symbols, parse_symbols
from yourtts.TTS.utils.generic_utils import find_module


def setup_model(config):
    print(" > Using model: {}".format(config.model))
    MyModel = find_module("yourtts.TTS.tts.models", config.model.lower())
    ...
    if config.characters is not None:
        ...
        from yourtts.TTS.tts.utils.text.symbols import phonemes, symbols  # pylint: disable=import-outside-toplevel
...
# import_models(models_dir, "yourtts.TTS.tts.models")
