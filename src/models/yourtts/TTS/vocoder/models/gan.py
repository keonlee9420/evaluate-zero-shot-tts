...
from yourtts.TTS.vocoder.datasets.gan_dataset import GANDataset
from yourtts.TTS.vocoder.layers.losses import DiscriminatorLoss, GeneratorLoss
from yourtts.TTS.vocoder.models import setup_discriminator, setup_generator
...
class GAN(BaseVocoder):
    def __init__(self, config: Coqpit):
        ...
        Examples:
            ...
            >>> from yourtts.TTS.vocoder.configs import HifiganConfig
