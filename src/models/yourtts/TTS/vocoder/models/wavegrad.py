...
from yourtts.TTS.vocoder.datasets import WaveGradDataset
from yourtts.TTS.vocoder.layers.wavegrad import Conv1d, DBlock, FiLM, UBlock
...
class Wavegrad(BaseModel):
    ...
    Examples:
        ...
        >>> from yourtts.TTS.vocoder.configs import WavegradConfig
