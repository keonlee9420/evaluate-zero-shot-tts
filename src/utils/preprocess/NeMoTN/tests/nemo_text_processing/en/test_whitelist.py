...
class TestWhitelist:
    ...
    @parameterized.expand(
        parse_test_case_file(
            "en/data_inverse_text_normalization/test_cases_whitelist.txt"
        )
    )
    ...
    @parameterized.expand(
        parse_test_case_file(
            "en/data_inverse_text_normalization/test_cases_whitelist_cased.txt"
        )
    )
    @pytest.mark.run_only_on("CPU")
    @pytest.mark.unit
    ...
    @parameterized.expand(
        parse_test_case_file(
            "en/data_text_normalization/test_cases_whitelist.txt"
        )
    )
    @pytest.mark.run_only_on("CPU")
    @pytest.mark.unit
