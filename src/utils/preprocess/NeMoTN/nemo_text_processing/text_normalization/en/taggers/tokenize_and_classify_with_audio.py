...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            deterministic_ordinal = OrdinalFst(
            ...
            fraction = FractionFst(
                deterministic=deterministic, cardinal=cardinal
            )
            ...
            v_date_graph = vDate(
                ordinal=ordinal, deterministic=deterministic
            ).fst
            v_money_graph = vMoney(
            ...
            det_v_date_graph = vDate(
                ordinal=vOrdinal(deterministic=True), deterministic=True
            ).fst
