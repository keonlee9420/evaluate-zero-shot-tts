...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        digit_tens = pynini.string_file(
            get_abs_path("data/number/digit_tens.tsv")
        )
        ...
        graph_teen = (
            ...
            + (
                (
                    pynini.closure(delete_punct)
                    + (pynini.closure(delete_punct) + digit)
                )
        ...
        graph_teen_alt = (
            ...
            | (
                pynini.closure(delete_punct)
                + (pynini.cross("1,0", "一十") | pynini.cross("1，0", "一十"))
            )
        ...
        graph_tenthousand = (
            (
                ...
                + (
                    pynutil.delete("0000")
                    | (pynutil.delete("0,000") | pynutil.delete("0，000"))
                )
                + tenthousand_digit
            )
            ...
            | (
                ...
                + (
                    pynini.cross("000", "零")
                    | (pynini.cross("0,00", "零") | pynini.cross("0，00", "零"))
                )
                + digit
            )
        )
        ...
        graph_hundredmillion = (
            pynutil.add_weight(
                (
                    digit
                    + (
                        pynutil.delete("00000000")
                        | (
                            pynutil.delete("00,000,000")
                            | pynutil.delete("00，000，000")
                        )
                    )
            ...
            | pynutil.add_weight(
                (digit + hundredmillion_digit + graph_tenmillion), -1.9
            )
            | pynutil.add_weight(
                (
                    digit
            ...
            | pynutil.add_weight(
                (
                    ...
                    + (
                        pynutil.delete("000")
                        | (pynutil.delete("00,0") | pynutil.delete("00，0"))
                    )
                    + pynutil.insert("零")
                    + graph_tenthousand
                ),
            ...
            | pynutil.add_weight(
                (
                    ...
                    + (
                        pynutil.delete("0000")
                        | (pynutil.delete("00,00") | pynutil.delete("00，00"))
                    )
                    + pynutil.insert("零")
                    + graph_thousand
                ),
            ...
            | pynutil.add_weight(
                (
                    ...
                    + hundredmillion_digit
                    + (
                        pynutil.delete("0000000")
                        | (
                            pynutil.delete("00,000,00")
                            | pynutil.delete("00，000，00")
                        )
                    )
                    + pynutil.insert("零")
        ...
        graph_tenbillion = (
            ...
            | pynutil.add_weight(
                (graph_hundred + hundredmillion_digit + graph_tenmillion), -1.9
            )
            | pynutil.add_weight(
                (
                    graph_hundred
        ...
        graph_hundredbillion = (
            ...
            | pynutil.add_weight(
                (graph_thousand + hundredmillion_digit + graph_tenmillion), -1.9
            )
            | pynutil.add_weight(
                (
                    graph_thousand
        ...
        final_graph_numbers_only = (
            pynutil.insert('integer: "') + graph + pynutil.insert('"')
        )
        # imprted when building other grammars
        self.just_cardinals = (
            graph | graph_mandarin | final_graph_sign | graph_mandarin_sign
        )
        graph_mandarins = (
            pynutil.insert('integer: "') + graph_mandarin + pynutil.insert('"')
        )
