...
class Measure(GraphFst):
    ...
    def __init__(
        ...
        integer_component = (
            pynutil.insert('integer: "') + graph_cardinal + pynutil.insert('"')
        )
        unit_component = (
        ...
        graph_cardinal_measure = (
            integer_component + insert_space + unit_component
        )
        ...
        graph = pynini.closure(graph_sign + insert_space) + (
            graph_cardinal_measure | graph_decimal
        )
