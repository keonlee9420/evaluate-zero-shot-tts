...
from nemo_text_processing.text_normalization.it.utils import (
    get_abs_path,
    load_labels,
)
...
fem_plural = pynini.string_file(
    (get_abs_path("data/money/currency_plural_fem.tsv"))
)
masc_plural = pynini.string_file(
...
class MoneyFst(GraphFst):
    ...
    def __init__(
        ...
        final_graph = graph | pynutil.add_weight(
            decimal_graph_with_minor, -0.001
        )
