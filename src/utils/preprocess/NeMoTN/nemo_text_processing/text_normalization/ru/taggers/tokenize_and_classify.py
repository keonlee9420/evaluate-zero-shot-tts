...
from nemo_text_processing.text_normalization.ru.taggers.cardinal import (
    CardinalFst,
)
from nemo_text_processing.text_normalization.ru.taggers.date import DateFst
from nemo_text_processing.text_normalization.ru.taggers.decimals import (
    DecimalFst,
)
from nemo_text_processing.text_normalization.ru.taggers.electronic import (
    ElectronicFst,
)
from nemo_text_processing.text_normalization.ru.taggers.measure import (
    MeasureFst,
)
from nemo_text_processing.text_normalization.ru.taggers.money import MoneyFst
from nemo_text_processing.text_normalization.ru.taggers.number_names import (
    get_alternative_formats,
    get_number_names,
)
from nemo_text_processing.text_normalization.ru.taggers.ordinal import (
    OrdinalFst,
)
from nemo_text_processing.text_normalization.ru.taggers.telephone import (
    TelephoneFst,
)
from nemo_text_processing.text_normalization.ru.taggers.time import TimeFst
from nemo_text_processing.text_normalization.ru.taggers.whitelist import (
    WhiteListFst,
)
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            self.date = DateFst(
                number_names=number_names, deterministic=deterministic
            )
