...
class TimeFst(GraphFst):
    ...
    def __init__(self, cardinal_tagger: GraphFst, deterministic: bool = True):
        super().__init__(
            name="time", kind="verbalize", deterministic=deterministic
        )
        ...
        graph_hm = (
            hour_verbalized + pynini.accep(" ") + minute @ number_verbalization
        )
        ...
        graph_m_past_h = (
            ...
            + hour
            @ pynini.cdrewrite(night_to_early, "[BOS]", "[EOS]", NEMO_SIGMA)
