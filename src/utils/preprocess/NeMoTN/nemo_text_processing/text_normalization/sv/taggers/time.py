...
class TimeFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        suffix_graph = pynini.string_map(
            load_labels(get_abs_path("data/time/suffix.tsv"))
        )
        ...
        final_graph_minute = (
            ...
            + (
                pynutil.delete("0") + insert_space + graph_minute_single
                | graph_minute_double
            )
            + pynutil.insert('"')
        )
