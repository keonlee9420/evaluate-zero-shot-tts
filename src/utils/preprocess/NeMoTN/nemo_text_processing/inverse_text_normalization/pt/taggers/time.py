...
class TimeFst(GraphFst):
    ...
    def __init__(self):
        ...
        # Mapping 'horas'
        graph_hour = pynutil.delete(
            pynini.accep("hora") + pynini.accep("s").ques
        )
        graph_minute = pynutil.delete(
            pynini.accep("minuto") + pynini.accep("s").ques
        )
        ...
        graph_minutes_component_without_zero |= (
            graph_e_meia
            + pynutil.delete(delete_space + pynini.accep("hora")).ques
        )
        final_graph_minute = (
        ...
        graph_pra_hour |= (
            pynutil.insert('hours: "')
            + (graph_meia_noite @ graph_hours_to)
            + pynutil.insert('"')
        )
        ...
        final_suffix = (
            ...
            + (graph_suffix_am | graph_suffix_pm)
            + pynutil.insert('"')
        )
        ...
        final_graph = pynini.union(
            (graph_hm | graph_mh) + final_suffix_optional
        ).optimize()
