...
class MoneyFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, decimal: GraphFst):
        ...
        accept_all_currency = (
            convert_currency_major | convert_currency_minor
        ).project(
            "input"
        ...
        delete_minor_currency = delete_extra_space + pynutil.delete(
        ...
        final_graph = (
            graph_money_large_round_amounts | graph_money_standard_amounts
        )
