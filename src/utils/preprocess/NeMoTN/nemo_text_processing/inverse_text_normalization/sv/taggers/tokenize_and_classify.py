...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            tn_ordinal_tagger = TNOrdinalTagger(
                cardinal=tn_cardinal_tagger, deterministic=False
            )
            tn_date_tagger = TNDateTagger(
                cardinal=tn_cardinal_tagger,
                ordinal=tn_ordinal_tagger,
                deterministic=False,
            )
            ...
            fraction = FractionFst(
                itn_cardinal_tagger=cardinal,
                tn_fraction_tagger=tn_fraction_tagger,
            )
            ...
            whitelist_graph = WhiteListFst(
                input_file=whitelist, input_case=input_case
            ).fst
            ...
            telephone_graph = TelephoneFst(
                ...
                tn_telephone_tagger=tn_telephone_tagger,
            ).fst
