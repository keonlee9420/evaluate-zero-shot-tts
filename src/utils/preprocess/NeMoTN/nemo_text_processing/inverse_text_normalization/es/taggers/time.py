...
class TimeFst(GraphFst):
    ...
    def __init__(self):
        ...
        minutes_to_graph = pynini.string_file(
        ...
        graph_hour = pynini.cross(
            "las ", "las "
        ) + graph_1_to_100 @ pynini.union(*digits_2_to_23)
        ...
        final_graph_minute = (
            ...
            + pynini.closure(
                (pynutil.delete("y") | pynutil.delete("con")) + delete_space,
                0,
                1,
            )
        ...
        graph_1oclock_with_suffix = pynini.closure(
            pynini.accep("la "), 0, 1
        ) + pynini.cross("una", "1")
        graph_hour_with_suffix = pynini.closure(
            pynini.accep("las "), 0, 1
        ) + graph_1_to_100 @ pynini.union(*digits_2_to_23)
        final_graph_hour_with_suffix = (
            pynutil.insert('hours: "')
            + (graph_1oclock_with_suffix | graph_hour_with_suffix)
            + pynutil.insert('"')
        )
