...
class MeasureFst(GraphFst):
    ...
    def __init__(
        self, cardinal: GraphFst, decimal: GraphFst, fraction: GraphFst
    ):
        ...
        subgraph_fraction |= pynutil.add_weight(
            (
                fraction.fst
                | (
                    (NEMO_SIGMA + pynini.cross("y medio", "y un medio"))
                    @ fraction.fst
                )
            )
            + delete_extra_space
        ...
        math_operation = (
            math_long_side + equal_symbol + delete_extra_space + math_short_side
        )
        math_operation |= (
            math_short_side
            + delete_extra_space
