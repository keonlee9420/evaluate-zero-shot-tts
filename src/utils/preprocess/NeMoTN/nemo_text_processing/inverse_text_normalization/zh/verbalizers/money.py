...
class MoneyFst(GraphFst):
    def __init__(self):
        ...
        graph_only_minor_regular = (
            currency_unit + delete_space + pynutil.insert("0.") + fraction_unit
        )
        graph_large_money = (
            currency_unit
            + delete_space
        ...
        graph_mandarin = (
            (graph_kuai | graph_mao | graph_fen)
            | graph_kuaimao
            | graph_kuaifen
            | graph_maofen
            | graph_all
        ...
        graph_verbalizer = graph_regular | pynutil.add_weight(
            graph_mandarin, -2.0
        )
