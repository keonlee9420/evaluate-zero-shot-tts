...
class OrdinalFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        numbers_graph = (
            pynutil.insert('integer: "') + numbers + pynutil.insert('"')
        )

        suffixes = pynini.string_file(
            get_abs_path("data/ordinals/suffixes.tsv")
        )
        suffixes_graph = (
        ...
        final_graph = (
            numbers_graph + pynutil.insert(NEMO_SPACE) + suffixes_graph
        )
