...
class FractionFst(GraphFst):
    ...
    def __init__(
        ...
        pluralize_denom = pynini.closure(NEMO_SIGMA) + pynini.cross(
            '"ième"', '"ièmes"'
        )
        ...
        integer_part = (
            pynutil.insert('integer_part: "') + cardinals + pynutil.insert('"')
        )
        optional_integer_part = pynini.closure(
            integer_part + pynini.accep(" "), 0, 1
        )
        ...
        final_graph = (
            ...
            + (sing_fraction_graph | pl_fraction_graph)
        )
