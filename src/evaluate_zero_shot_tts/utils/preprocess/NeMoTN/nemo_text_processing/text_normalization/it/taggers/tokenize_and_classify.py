...
from nemo_text_processing.text_normalization.it.taggers.decimals import (
    DecimalFst,
)
from nemo_text_processing.text_normalization.it.taggers.electronic import (
    ElectronicFst,
)
from nemo_text_processing.text_normalization.it.taggers.measure import (
    MeasureFst,
)
from nemo_text_processing.text_normalization.it.taggers.money import MoneyFst
from nemo_text_processing.text_normalization.it.taggers.whitelist import (
    WhiteListFst,
)
