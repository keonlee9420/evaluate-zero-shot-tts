...
class CardinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        digit_100 = pynini.string_file(
            get_abs_path("data/number/digit_100.tsv")
        )
        digit_1000 = pynini.string_file(
            get_abs_path("data/number/digit_1000.tsv")
        )
        ...
        reverse_digits = pynini.string_file(
            get_abs_path("data/number/flops.tsv")
        )
        ...
        hundreds_zero = (
            ...
            + insert_space
            + pynutil.insert("مئة")
            + pynutil.delete("00", weight=0.001)
        )
        hundreds_plus = (
            digit_100
            + insert_space
        ...
        thousands_zero = (
            ...
            + pynutil.delete("000", weight=0.001)
        )
        thousands_plus = (
            digit_1000
            + insert_space
        ...
        graph_two_thousands = two_thousands + pynutil.delete(
            "000", weight=0.001
        )
        ...
        graph = (
            graph_all | graph_all_hundreds | graph_all_thousands | graph_zero
        )
