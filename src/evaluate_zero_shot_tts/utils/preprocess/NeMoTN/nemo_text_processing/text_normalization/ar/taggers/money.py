...
from nemo_text_processing.text_normalization.ar.utils import (
    get_abs_path,
    load_labels,
)
...
class MoneyFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        for curr_symbol, _ in maj_singular_labels:
            ...
            digits_two_to_ten = pynini.union(
                "2", "3", "4", "5", "6", "7", "8", "9", "10"
            )

            graph_fractional_up_to_ten = (
                two_digits_fractional_part @ digits_two_to_ten @ cardinal_graph
            )
            graph_fractional_up_to_ten = (
                pynutil.insert('fractional_part: "')
                + graph_fractional_up_to_ten
            ...
            graph_fractional = (
                ...
                @ (
                    ...
                    - pynini.union("2", "3", "4", "5", "6", "7", "8", "9", "10")
                )
                @ cardinal_graph
            )
            graph_fractional = (
