...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        graph_tens = teen
        graph_tens |= ties + (
            pynutil.delete("0") | (pynutil.insert(" y ") + graph_digit)
        )
        graph_tens |= twenties
        ...
        graph_million = pynutil.add_weight(
            pynini.cross("000001", "un millón"), -0.001
        )
        graph_million |= (
            graph_thousands_component_at_least_one_none_zero_digit_no_one
        ...
        graph_billion = pynutil.add_weight(
            pynini.cross("000001", "un billón"), -0.001
        )
        graph_billion |= (
            graph_thousands_component_at_least_one_none_zero_digit_no_one
        ...
        graph_trillion = pynutil.add_weight(
            pynini.cross("000001", "un trillón"), -0.001
        )
        graph_trillion |= (
            graph_thousands_component_at_least_one_none_zero_digit_no_one
