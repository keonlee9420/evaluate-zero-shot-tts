...
class MathSymbol(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        super().__init__(
            name="sign", kind="classify", deterministic=deterministic
        )
        """
        ...
        """
        score_sign = pynini.string_file(
            get_abs_path("data/math/score.tsv")
        ) | pynini.string_file(get_abs_path("data/math/symbol.tsv"))
        score = (
