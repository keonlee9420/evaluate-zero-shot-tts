...
class MoneyFst(GraphFst):
    ...
    def __init__(
        self, decimal: GraphFst, deterministic: bool = True, lm: bool = False
    ):
        super().__init__(
        ...
        # graphs
        graph_regular_money = (
            number_component + delete_space + currency_component
        )
        ...
        graph_decimal_money = (
            decimal_component + delete_space + currency_component
        )
