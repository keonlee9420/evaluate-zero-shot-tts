...
class FractionFst(GraphFst):
    ...
    def __init__(
        ...
        graph_with_suffix = (
            pynini.closure(
                pynutil.insert('denominator: "') + suffix + pynutil.insert('"'),
                0,
                1,
            )
            + morpheme
        ...
        graph_hundred = pynutil.delete("100%") + pynutil.insert(
            'numerator: "百" denominator: "百"'
        )
        ...
        graph_optional_sign = (
            ...
            | (
                pynini.closure(
                    pynutil.insert("positive: ") + pynini.cross("+", '"正"')
                )
            )
            | (
