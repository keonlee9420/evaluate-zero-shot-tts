    ...
    def __init__(self, deterministic: bool = True):
        ...
        def add_space_after_char():
            return pynini.closure(
                NEMO_NOT_QUOTE - pynini.accep(" ") + insert_space
        ...
        protocol = (
            ...
            pynini.cross("snedstreck snedstreck", "dubbla snedstreck"),
            bos_or_space,
            eos_or_space,
            NEMO_SIGMA,
        )
        self.graph = (
            pynini.closure(protocol + pynini.accep(" "), 0, 1) + domain
        ) | (
