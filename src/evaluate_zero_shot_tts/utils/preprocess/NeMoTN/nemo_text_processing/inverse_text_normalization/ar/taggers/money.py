...
from nemo_text_processing.text_normalization.ar.taggers.money import (
    ar_cur,
    maj_singular,
    min_plural,
    min_singular,
...
class MoneyFst(GraphFst):
    ...
    def __init__(
        self, itn_cardinal_tagger: GraphFst, deterministic: bool = True
    ):
        super().__init__(
