...
class FractionFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        graph_strip_no_root_change = pynutil.delete(
            "ième"
        ...
        self.fractional = (
            (pynini.closure(NEMO_CHAR) + graph_strip) @ graph_cardinal
        ).optimize()
        ...
        graph_demi_component = (
            pynutil.delete("demi")
            + pynutil.delete("e").ques
            + pynutil.delete("s").ques
        )
        graph_demi_component += pynutil.insert(
