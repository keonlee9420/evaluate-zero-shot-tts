...
class OrdinalFst(GraphFst):
    ...
    def __init__(self):
        ...
        replace_suffix = (
            pynutil.delete(' morphosyntactic_features: "') + replace_suffix.plus
        )
        ...
        graph_roman_ties = pynini.string_file(
            get_abs_path("data/roman/ties_large.tsv")
        ).invert()
        ...
        graph_roman_integers = (
            graph_roman_hundreds | graph_roman_ties | graph_roman_digits
        )
