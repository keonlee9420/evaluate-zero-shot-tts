...
class TimeFst(GraphFst):
    ...
    def __init__(self):
        ...
        quarters = pynini.string_file(
            get_abs_path("data/time/time_quarters.tsv")
        )
        for_mandarin = pynini.string_file(
            get_abs_path("data/time/time_mandarin.tsv")
        )
        ...
        minute_mandarin = (
            pynini.accep("分") | pynini.cross("分鐘", "分钟") | pynini.accep("分钟")
        )
        second_mandarin = (
            pynini.accep("秒") | pynini.cross("秒鐘", "秒钟") | pynini.accep("秒钟")
        )
        ...
        graph_mandarin_hour = (
            pynutil.insert('hours: "') + hours_only + pynutil.insert('"')
        )
        graph_mandarin_minute = (
            pynutil.insert('minutes: "') + minutes_only + pynutil.insert('"')
        )
        graph_mandarin_second = (
            pynutil.insert('seconds: "') + seconds_only + pynutil.insert('"')
        )
