...
class TelephoneFst(GraphFst):
    ...
    def __init__(
        self, tn_cardinal_tagger: GraphFst, tn_telephone_tagger: GraphFst
    ):
        ...
        two_digits = pynini.invert(
            tn_cardinal_tagger.two_digits_read
        ).optimize()
        three_digits = pynini.invert(
            tn_cardinal_tagger.three_digits_read
        ).optimize()
