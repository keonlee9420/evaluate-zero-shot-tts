...
class OrdinalFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        full_graph_ties = graph_ties | (
            graph_ties + pynini.cross(" ", "y") + graph_digit
        )
        ...
        optional_numbers_in_front = (
            ...
            + delete_space.closure()
        ).closure()
        graph_o_suffix = (
            optional_numbers_in_front + ordinal_graph_o
        ) @ cardinal_graph
        graph_a_suffix = (
            optional_numbers_in_front + ordinal_graph_a
        ) @ cardinal_graph
        graph_er_suffix = (
            optional_numbers_in_front + ordinal_graph_er
        ) @ cardinal_graph
