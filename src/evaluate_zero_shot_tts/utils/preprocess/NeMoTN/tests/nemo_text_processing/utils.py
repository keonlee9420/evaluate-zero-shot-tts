...
def parse_test_case_file(file_name: str):
    ...
    test_pairs = []
    with open(
        os.path.dirname(os.path.abspath(__file__)) + os.path.sep + file_name,
        "r",
    ) as f:
        for line in f:
...
def get_test_cases_multiple(
    file_name: str = "data_text_normalization/en/test_cases_normalize_with_audio.txt",
):
    """
