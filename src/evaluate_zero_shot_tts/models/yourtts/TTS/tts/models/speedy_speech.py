...
from yourtts.TTS.tts.layers.glow_tts.monotonic_align import generate_path
...
class SpeedySpeech(BaseTTS):
    ...
    def get_criterion(self):
        from yourtts.TTS.tts.layers.losses import SpeedySpeechLoss  # pylint: disable=import-outside-toplevel
