...
from yourtts.TTS.tts.layers.align_tts.mdn import MDNBlock
from yourtts.TTS.tts.layers.feed_forward.decoder import Decoder
from yourtts.TTS.tts.layers.feed_forward.duration_predictor import DurationPredictor
from yourtts.TTS.tts.layers.feed_forward.encoder import Encoder
from yourtts.TTS.tts.layers.generic.pos_encoding import PositionalEncoding
...
class AlignTTS(BaseTTS):
    ...
    Examples:
        >>> from yourtts.TTS.tts.configs import AlignTTSConfig
    ...
    def get_criterion(self):
        from yourtts.TTS.tts.layers.losses import AlignTTSLoss  # pylint: disable=import-outside-toplevel
