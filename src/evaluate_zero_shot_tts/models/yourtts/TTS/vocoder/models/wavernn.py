...
from yourtts.TTS.tts.utils.visual import plot_spectrogram
from yourtts.TTS.utils.audio import AudioProcessor
from yourtts.TTS.utils.io import load_fsspec
from yourtts.TTS.vocoder.datasets.wavernn_dataset import WaveRNNDataset
from yourtts.TTS.vocoder.layers.losses import WaveRNNLoss
from yourtts.TTS.vocoder.models.base_vocoder import BaseVocoder
from yourtts.TTS.vocoder.utils.distribution import sample_from_discretized_mix_logistic, sample_from_gaussian
...
class Wavernn(BaseVocoder):
    def __init__(self, config: Coqpit):
        ...
        Examples:
            >>> from yourtts.TTS.vocoder.configs import WavernnConfig
